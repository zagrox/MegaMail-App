...
const resources = {
  ...
  fa: {
    translation: {
      ...
      whitelabelInfo: 'آیا به نسخه وایت لیبل {{appName}} علاقه‌مندید یا به نصب سفارشی بر روی زیرساخت خود نیاز دارید؟ ما راه‌حل‌هایی متناسب با برند و نیازهای فنی شما ارائه می‌دهیم.',
